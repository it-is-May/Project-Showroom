...
int main(int argc, char *argv[])
{
    ...
    int port = 23450;         // default port# of the server
    ...
    system(" netstat -aont | grep \" `hostname -i`:23450 \" ");

    printf("\n timeClient: connecting to 127.0.0.1 Port#=23450 \n");
    ...
    system("ps");
    system(" netstat -aont | grep \":23450 \" ");
    printf("\n\n");
